...
export default function Integrantes() {
  ...
  return (
    <div className="max-w-[1100px] mx-auto px-6 py-12">
      ...
      <p className="text-center text-white/70 mb-2">Conheca a equipe por tras do RockySoulUp</p>
        ...
        {INTEGRANTES.map(m => (
          <div key={m.rm} className="bg-white/80 backdrop-blur-sm rounded-2xl shadow-sm p-6 text-center hover:shadow-md transition-all border border-white/40 hover:scale-[1.02]">
            ...
            <div className="flex justify-center gap-4">
              ...
              <a href={m.linkedin} target="_blank" rel="noopener noreferrer" className="text-gray-400 hover:text-[#0077b5] transition-colors" title="LinkedIn">
                <svg width="22" height="22" viewBox="0 0 24 24" fill="currentColor">
