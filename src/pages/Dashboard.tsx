...
function getGreeting(nivel: string): string {
  switch (nivel) {
    case 'Semente':
      return 'Continue plantando sementes!';
    case 'Broto':
      return 'Você está crescendo!';
    case 'Árvore':
      return 'Que impacto incrível!';
    case 'Expert':
...
function getProgressPercent(pontos: number): number {
  ...
  if (pontos >= 300) {
    return 30 + ((pontos - 300) / 700) * 70;
  }

  if (pontos >= 100) {
    return 10 + ((pontos - 100) / 200) * 20;
  }

  return (pontos / 100) * 10;
}

function getNextLevel(pontos: number): {
  nome: string;
  falta: number;
} {
  if (pontos < 100) {
...
function getDicaDoDia(): string {
  ...
  const diaDoAno = Math.floor(
    (hoje.getTime() - inicioAno.getTime()) / 86400000
  );
...
export default function Dashboard() {
  const {
    data,
    getNivel,
    getSelosDesbloqueados,
    desafioDoDia,
    desafioBonusDisponivel,
  ...
  ] = useState<(typeof MISSOES)[0] | null>(null);
  ...
  const selosDesbloqueados =
    getSelosDesbloqueados();

  const progresso =
    getProgressPercent(data.pontos);

  const nextLevel =
    getNextLevel(data.pontos);
  ...
  const recentHistory =
    data.historico.slice(0, 8);

  const totalCO2 =
    data.historico.reduce(
      (acc, entry) => {
        const missaoId =
          getMissaoIdByName(entry.nome);
  ...
  function handleMissao(
    missao: (typeof MISSOES)[0]
  ) {
  ...
  const impacto = [
    {
      icon: '/icons/folha.svg',
      label: 'kg CO₂ evitado',
      value: totalCO2.toFixed(1),
    },
    {
      icon: '/icons/arvore.svg',
      label: 'Árvores equiv.',
      value: arvoresEquiv,
    },
    {
      icon: '/icons/semente.svg',
      label: 'Dias seguidos',
      value: `${diasSeguidos}d`,
    },
  ];
      ...
      <div className="max-w-[1700px] mx-auto px-4 sm:px-6 py-4 lg:py-6 flex flex-col lg:flex-row gap-4">
        ...
        <aside className="hidden lg:flex flex-col lg:w-75 shrink-0 gap-4">
          ...
          <div
            ...
            style={{
              background:
                'linear-gradient(160deg, rgba(7,31,18,0.70), rgba(15,60,34,0.60))',
          ...
          >
            ...
            <div className="relative w-30 h-30">
              ...
              <div className="absolute inset-0 flex items-center justify-center">
                <div
                  className="w-20 h-20 rounded-full flex items-center justify-center text-2xl font-bold text-[#0f3c22]"
                  style={{
                    background:
            ...
            <div className="w-full grid grid-cols-2 gap-2 mt-1">
              {[
                ...
                {
                  label: 'Hoje',
                  value: data.pontosHoje,
                  suffix: 'pts',
                },
                {
                  label: 'Missões',
                  value: data.missoesCompletas,
                  suffix: '',
                },
                {
                  label: 'Streak',
            ...
            <div className="w-full">
              <div className="flex justify-between text-[11px] text-white/50 mb-1.5">
                <span>
                  Próximo: {nextLevel.nome}
                </span>

                <span>
                  {nextLevel.falta} pts restantes
                </span>
              </div>
          ...
          <div className="glass-strong rounded-2xl p-4">
            <p className="text-white/55 text-[11px] uppercase tracking-widest mb-3">
              Trilha de Evolução
            </p>
              ...
              {SELOS.map((l, i, arr) => {
                ...
                return (
                  ...
                  >
                    {i < arr.length - 1 && (
                      <div
                        className="absolute left-3.5 top-7 w-px h-4"
                        style={{
                          background: unlocked
                            ? 'rgba(74,222,128,0.4)'
                            : 'rgba(255,255,255,0.06)',
                    ...
                    {active && (
                      <span className="ml-auto text-[11px] text-green-400 font-semibold">
                        atual
                      </span>
                    )}
                  </div>
            ...
            <div className="flex flex-col gap-2.5">
              {impacto.map((m) => (
                ...
                >
                  ...
                  <p className="text-green-300 font-bold text-base font-serif-display">
                    {m.value}
                  </p>
                </div>
              ))}
        ...
        <div className="flex-1 min-w-0 flex flex-col gap-5">
          ...
          <div>
            ...
            <h1
              className="text-white mt-0.5 font-serif-display"
              style={{ fontSize: 30 }}
            >
              {nomeExibido}{' '}
          ...
          <div className="grid grid-cols-1 md:grid-cols-5 gap-4">
            ...
            <div
              ...
              style={{
                background:
                  'linear-gradient(125deg, rgba(15,60,34,0.9), rgba(34,197,94,0.18))',
                border:
            ...
            >
              <div
                ...
                style={{
                  background:
                    'radial-gradient(#4ade80, transparent)',
                }}
              />
              ...
              <div className="flex items-center gap-2 mb-3">
                ...
                <span className="ml-auto text-green-400/60 text-xs">
                  {desafioBonusDisponivel
                    ? `+${desafioDoDia.pontos} pts · bônus extra`
                    : 'bônus já resgatado'}
                </span>
              </div>
            ...
            <div className="md:col-span-2 glass-strong rounded-2xl p-5 flex flex-col gap-3">
              ...
              <span className="text-green-400/60 text-[11px] font-medium">
                Verificado pela IA
              </span>
            </div>
          </div>
              ...
              {MISSOES.map((missao) => {
                ...
                return (
                  <button
                    ...
                    style={{
                      background: checked
                        ? `rgba(${hexToRgb(cor)},0.08)`
                        : 'rgba(255,255,255,0.06)',

                      border: checked
                        ? `1px solid rgba(${hexToRgb(cor)},0.25)`
          ...
          <div className="lg:hidden glass-strong rounded-2xl p-4 grid grid-cols-3 gap-3">
            {impacto.map((m) => (
              ...
              >
                ...
                <p
                  className="text-green-300 font-bold mt-1 font-serif-display"
                  style={{ fontSize: 20 }}
                >
                  {m.value}
                </p>
        ...
        <aside className="hidden xl:flex flex-col xl:w-75 shrink-0 gap-4">
          ...
          <div className="glass-strong rounded-2xl p-4">
            ...
            <div className="flex flex-col gap-0.5">
              ...
              <div
                className="flex items-center gap-2.5 rounded-xl px-2.5 py-2 mt-1"
                style={{
                  background:
              ...
              >
                <span
                  className="w-6 h-6 rounded-full flex items-center justify-center text-[11px] font-bold text-white/30 shrink-0"
                  style={{
                    background:
                      'rgba(255,255,255,0.05)',
                  }}
                  ...
                  (
                    ...
                    return (
                      ...
                      >
                        ...
                        {entry.pontos > 0 && (
                          <span className="text-green-400 text-xs font-bold shrink-0 mt-1">
                            +{entry.pontos}
                          </span>
                        )}
                      </div>
