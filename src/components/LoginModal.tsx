        ...
        <form onSubmit={handleSubmit} className="flex flex-col gap-4" noValidate>
          <div>
            ...
            <input
              ...
              className={`w-full border rounded-xl px-4 py-3 text-sm text-gray-900 placeholder:text-gray-400 outline-none focus:border-[#22c55e] focus:ring-1 focus:ring-[#22c55e] transition-colors bg-white/60 ${erros.nome ? 'border-red-400' : 'border-gray-200'
                }`}
            />
          ...
          <div>
            ...
            <input
              ...
              className={`w-full border rounded-xl px-4 py-3 text-sm text-gray-900 placeholder:text-gray-400 outline-none focus:border-[#22c55e] focus:ring-1 focus:ring-[#22c55e] transition-colors bg-white/60 ${erros.email ? 'border-red-400' : 'border-gray-200'
                }`}
            />
