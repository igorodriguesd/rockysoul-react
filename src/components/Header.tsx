...
export default function Header() {
  ...
  return (
    <>
      <header className="fixed top-4 left-1/2 -translate-x-1/2 z-100 w-[calc(100%-2rem)] max-w-275 px-5 sm:px-6 py-4 flex items-center justify-between rounded-3xl bg-[#0c3a22] border border-white/10 shadow-[0_12px_32px_rgba(0,0,0,0.35)] box-border">
        ...
        <div className="flex items-center gap-5">
          ...
          <div className="flex items-center gap-3 relative" ref={avatarRef}>
            ...
            {usuarioAberto && (
              <div className="absolute right-0 top-full mt-3 w-72 rounded-2xl bg-[#0f1c2e] shadow-2xl border border-white/10 p-3 z-120">
      ...
      {menuAberto && (
        <div className="fixed top-20 right-6 z-100 lg:hidden w-48 bg-[#0f1c2e] shadow-lg rounded-2xl p-3 border border-white/10">
